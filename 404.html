...
<head>
	...
	<title>Aveed's Auto Detailing</title>
			...
			<div class="headerFixer">
				<header id="pageHeader" class="bg-white">
					<div class="container-fluid clearfix">
						<div class="logo">
							<a href="/">
								<img src="images/logo.png" class="img-fluid" alt="Aveed's Auto Detailing" width="100px">
							</a>
						</div>
						<nav id="pageNav" class="navbar navbar-expand-lg navbar-light justify-content-end justify-content-lg-start position-static">
							...
							<div class="hdActionsWrap flex-shrink-0 d-flex justify-content-end align-items-center">
								<a href="tel:9166661207" class="btnHdLink fontAlter fwMedium d-none d-xl-inline">
								...
								<a href="tel:9166661207" class="btn btnThemeAlt border-0 p-0 ml-lg-3 ml-xxl-6 btnHd" data-hover="Book Appointment">
		...
		<main>
			<div class="introBlock innerPagesBanner">
				<article class="ibsColumn text-center d-flex w-100 position-relative text-white fontAlter">
					...
					<span class="bgCover ibsBgWrap w-100 h-100 position-absolute" style="background-image: url(images/img18.jpg);"></span>
				</article>
			</div>
				...
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-12 col-sm-9 col-lg-6 col-xlwd-4 text-center">
							...
							<a href="/" class="btnThemeAlt btn btnNoOver mt-5 btnMinXLarge">Back to Home <i class="fas fa-arrow-right btnIcn ml-2" aria-hidden="true"><span class="sr-only">icon</span></i></a>
						</div>
					</div>
				</div>
			</section>
						...
						<div class="row">
							...
							<div class="col-12 col-sm-6 col-lg-4 mb-10 mb-lg-0">
								...
								<ul class="list-unstyled ftpScheduleList mb-0">
									<li>
										<span class="d-block">Saturday 11:00 AM - 5:00 PM</span>
										<span class="d-block">Sunday 8:00 AM - 5:00 PM</span>
									</li>
								</ul>
							</div>
							<div class="col-12 col-sm-6 col-lg-4 mb-10 mb-lg-0">
								...
								<ul class="list-unstyled ftpScheduleList mb-0">
									<li>
										<span class="d-block">(916) 542-0774</span>
										<span class="d-block">service@aveedsauto.com</span>
									</li>
								</ul>
							</div>
						</div>
